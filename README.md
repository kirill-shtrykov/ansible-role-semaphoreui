...
semaphoreui_version: 2.18.27

# Database dialect. Supported values: sqlite, mysql, postgres.
# semaphoreui_dialect: postgres # Required

# SQLite database path.
semaphoreui_sqlite_host: /var/lib/semaphore/db.sqlite
...
# Semaphore UI listening port.
semaphoreui_port: 3000

# Network interface to listen on. Empty value listens on all interfaces.
semaphoreui_interface: ""

# Temporary directory used by Semaphore UI.
semaphoreui_tmp_path: /tmp/semaphore

# Web host name or address. Empty value disables the setting.
semaphoreui_web_host: ""

# Task concurrency mode.
semaphoreui_concurrency_mode: ""

# Maximum number of tasks that can run in parallel. 0 means unlimited.
semaphoreui_max_parallel_tasks: 0

# Secret key used to hash session cookies.
...
# Encryption key for Semaphore UI access keys.
# Must decode to 16, 24, or 32 bytes.
...
# Telegram chat ID used for alerts.
